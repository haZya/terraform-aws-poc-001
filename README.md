...
key          = "poc-001/bootstrap/state/terraform.tfstate"
...
```hcl
bucket       = "poc-001-terraform-state-000000000000"
key          = "poc-001/bootstrap/accounts/staging/terraform.tfstate"
region       = "ap-southeast-2"
profile      = "state-account"
encrypt      = true
use_lockfile = true
...
```hcl
bucket       = "poc-001-terraform-state-000000000000"
key          = "poc-001/bootstrap/accounts/prod/terraform.tfstate"
region       = "ap-southeast-2"
profile      = "state-account"
encrypt      = true
use_lockfile = true
